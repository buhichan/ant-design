...
var TextArea = /*#__PURE__*/React.forwardRef(function (_a, ref) {
  ...
  var hasMaxLength = Number(maxLength) > 0; // TextArea
  ...
  if (showCount) {
    var valueLength = hasMaxLength ? Math.min(Number(maxLength), (0, _toConsumableArray2["default"])(val).length) : (0, _toConsumableArray2["default"])(val).length;
